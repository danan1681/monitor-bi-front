...
import {RespuestaValidarSession} from "../../../../core/models/usuario.model";
...
export class HeaderComponent {
  ...
  constructor(
    ...
    this.claveRol = Number(localStorage.getItem('clave_rol'));
    this.claveDependencia = Number(localStorage.getItem('clave_dependencia'));
    ...
    this.starterService.getRoles().subscribe((roles: IRoles[]) => {
      ...
      // this.starterService.getDependencias().subscribe((dependencias: any) => {
      //   const dependenciaEncontrada = dependencias.find((dependencia: any) => dependencia.clave_dependencia === this.claveDependencia);
      //   this.nombreDependencia = dependenciaEncontrada?.nombre_dependencia || 'Sin Dependencia';
      // });
    });
  }
