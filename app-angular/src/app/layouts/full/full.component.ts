...
export class FullComponent implements OnInit {
  ...
  constructor(
    ...
    private starterServices: StarterServices

  ) {
    if(localStorage.getItem('rol') != 'Administrador' && localStorage.getItem('rol') != 'Superadministrador'){
    }
  ...
  ngOnInit(): void {
    ...
    this.claveRol = Number(localStorage.getItem('clave_rol')); // Convertir a número
    ...
    this.usuarioService.obtenerMenu().subscribe((response: any) => {
